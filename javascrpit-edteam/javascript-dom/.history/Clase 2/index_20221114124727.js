...
//Propagacion de eventos (Burbujear)
//sI NO QUIERES QUE SE PROPAGUE EL EVENTO
document.querySelectorAll('.div').forEach( e => {
    e.addEventListener('click', e => {
        console.log(`Hciiste click en el div ${e.target.id}`)
        e.stopPropagation()
    })
...
gallery.addEventListener('click', e => {
    const t = e.target
    const images = Array.from(gellery.querySelectorAll('img'))
