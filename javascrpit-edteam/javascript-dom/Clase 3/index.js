...
//getBoundingClientRect().left tamaño entre el borde izquierdo y el elemento
//getBoundingClientRect().bottom  espacio entre el elemento y el borde inferior de la ventana incluyendo el elemento
//getBoundingClientRect().width // ancho real de un elemento
//getBoundingClientRect().height // alto real de un elemento
//getBoundingClientRect().right // espacio entre el borde derecho y el elemento incluyendo el elemento
//getBoundingClientRect().top // espacio entre el elemento y el borde superior de la ventana
