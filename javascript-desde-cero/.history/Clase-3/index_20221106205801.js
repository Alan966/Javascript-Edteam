...
//Solo si es + lo va a sumar strings
//Si es - lo va a restar numeros

console.log(resp); // Los ve como strings

//NaN = Numero que no es un numero

//Busca si alguna de las variables es una cadena de texto y si lo es lo convierte en numero
a = true
b = true
c = false
console.log(a + b - c);