...
for(let i = 0 ; i < suegras.length; i++){
    console.log('Mi suegra se llama ' + suegras[i]);
}

for(let nombre of suegras){
    console.log('Mi suegra se llama ' + nombre);
}

let i = 0;
while(i < suegras.length){
    console.log('Mi novia se llama ' + suegras[i]);
}