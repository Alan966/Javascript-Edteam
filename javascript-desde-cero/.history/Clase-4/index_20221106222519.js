...
let ultimo = suegras.length-1;
console.log(ultimo);

for(let a = 0; a < suegras.length; a++){
    console.log('---')
    for(let i = 0; i < suegras[a].length; i++ ){
        console.log(suegras[a][i]);
    }
}
...
while(zapatos > 0){
    console.log(`Quieres un par de zapatos me sobran ${zapatos- 1}`);
    zapatos--;
}